          ...
          <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-12">
            ...
            <div className="bg-white dark:bg-gray-900 p-8 rounded-lg shadow-lg">
              ...
              <div className="space-y-4">
                <a
                  href="mailto:mohameddhiaselmii@gmail.com"
                  className="flex items-center gap-3 text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400"
                >
                  <Mail className="w-6 h-6" />
                  <span>mohameddhiaselmii@gmail.com</span>
                </a>
                <a
                  href="https://github.com/dhiaselmi1"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-3 text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400"
                >
                  <Github className="w-6 h-6" />
                  <span>github.com/dhiaselmi1</span>
                </a>
                <a
                  href="https://www.linkedin.com/in/mohamed-dhia-selmi"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-3 text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400"
                >
                  <Linkedin className="w-6 h-6" />
                  <span>www.linkedin.com/in/mohamed-dhia-selmi</span>
                </a>
              </div>
            </div>
