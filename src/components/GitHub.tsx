...
export function GitHub() {
  ...
  // Liste des projets à afficher (modifiez les noms selon vos besoins)
  ...
  useEffect(() => {
    ...
    fetch("https://api.github.com/users/dhiaselmi1")
    ...
    Promise.all(
      selectedProjects.map(projectName =>
        fetch(`https://api.github.com/repos/dhiaselmi1/${projectName}`)
          .then(response => {
            if (!response.ok) {
