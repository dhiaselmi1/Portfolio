# Mohamed Dhia Selmi - Portfolio Website for a Software Engineer & AI Enthusiast
...
Check it out live at: [https://dhiaselmi.vercel.app/](https://dhiaselmi.vercel.app/)
...
[![GitHub stars](https://img.shields.io/github/stars/dhiaselmi1/Portfolio.svg)](https://github.com/dhiaselmi1/Portfolio/stargazers)
[![GitHub forks](https://img.shields.io/github/forks/dhiaselmi1/Portfolio.svg)](https://github.com/dhiaselmi1/Portfolio/network)
[![GitHub issues](https://img.shields.io/github/issues/dhiaselmi1/Portfolio.svg)](https://github.com/dhiaselmi1/Portfolio/issues)
...
- **Dynamic Content**: Fetches data from GitHub API to display the latest repositories and contributions.
- **Interactive Icons**: Utilizes Lucide icons and React Icons for a modern and interactive design.
- **Logo Animation**: Framer-Motion is used to animate the MDS logo on the loading page.
...
- **Custom Sections**:
  ...
  - **GitHub**: Fetches and displays my GitHub repositories, contribution calendar, and profile statistics.
  - **Projects**: Features video demonstrations hosted on Cloudinary, Vimeo, and other platforms with support for direct video files and embeds.
...
- **GitHub API**: To fetch and display repositories and contributions.
- **Cloudinary**: For video hosting and optimization.
- **Vimeo**: For video embedding.
- **Framer-Motion**: For logo animation on loading screen.
- **React Slick**: For carousel components (certifications).
...
- **Email**: [mohameddhiaselmii@gmail.com](mailto:mohameddhiaselmii@gmail.com)
- **LinkedIn**: [linkedin.com/in/mohamed-dhia-selmi](https://linkedin.com/in/mohamed-dhia-selmi)
- **GitHub**: [github.com/dhiaselmi1](https://github.com/dhiaselmi1)
- **Website**: [dhiaselmi.vercel.app](https://dhiaselmi.vercel.app)

---

### 🔥 Made with ❤️ by **Mohamed Dhia Selmi**
